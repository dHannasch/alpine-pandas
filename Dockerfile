...
RUN apk --update add --no-cache --virtual opencv-python-build-dependencies build-base cmake cmake-extras extra-cmake-modules ninja libressl-dev gfortran g++ openblas-dev lapack-dev libuv-dev \
